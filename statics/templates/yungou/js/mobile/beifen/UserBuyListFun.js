$(function() {
    ...
    var c = function() {
        ...
        var k = function() {
            e.show();
            GetJPData("http://m.1ytb.cc", "getUserBuyList", j(),
            function(q) {
                if (q.code == 0) {
                    var n = q.listItems;
                    if (g.isCount == 1) {
                    ...
                    for (var p = 0; p < r; p++) {
                        ...
                        o += '<img src="' + Gobal.LoadPic + '" src2="http://mimg.1ytb.cc/GoodsPic/pic-200-200/' + n[p].goodsPic + '" border=0 alt=""></a><div class="u-sgl-r gray9"><p class="z-sgl-tt"><a class="gray6">(第' + n[p].codePeriod + "期)" + n[p].goodsName + "</a></p>";
                        if (m == 1 || m == 2) {
