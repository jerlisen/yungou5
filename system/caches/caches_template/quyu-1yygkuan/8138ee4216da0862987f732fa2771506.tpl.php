            ...
            <div class="footer">
                <div class="yFootSupport">
                    <div class="yFootSupport_in">
                            ...
                            <dl>
                                <dt>关于我们</dt>
                                <dd><a href="<?php echo WEB_PATH; ?>/help/1" target="_blank">了解淘吧</a></dd>
                           ...
                           <dl class="dl_Time">
                               ...
                               <dd title="一元淘吧公益基金"  id="nowTime" class="sysTime" style="background:url(<?php echo G_GLOBAL_STYLE; ?>/images/fund.png) no-repeat 0px 6px;background-size:21px;">
...
Copyright (c) 2015 <a href="http://www.1ytb.cc/" target="_blank" >一元淘吧 - 1ytb.cc</a> Corporation.All Rights Reserved. 欢迎使用一元淘吧购物系统</a>
                            </div>
                        </div>
                    </div>
            </div>
