...
<ul class="c_person_list">
	<li class=""><a href="<?php echo WEB_PATH; ?>/member/home/userbuylist" hidefocus="">1元淘记录</a></li>
	...
	<li class=""><a href="<?php echo WEB_PATH; ?>/member/home/userfufen" hidefocus="">我的淘豆</a></li>
...
<div class="R-content">
	<div class="subMenu">
                ...
                <a href="<?php echo WEB_PATH; ?>/member/home/userrechargedk" title="充值卡">充值卡</a>
    </div>
	<div class="select" style="margin-left: 190px;">
