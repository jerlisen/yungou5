...
<div class="Current_nav">
	...
	<a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $item['cateid']; ?>.html">
	<?php echo $category['name']; ?>
	</a><span>&gt;</span> 
	<a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $item['cateid']; ?>e<?php echo $item['brandid']; ?>.html">
	<?php echo $brand['name']; ?>
	</a> <span>&gt;</span>商品详情
</div>
	...
	<div class="Pro_Details">
		...
		<div class="Pro_Detleft">
			...
			<div class="Pro_GetPrize">				
				...
				<div class="GetPrize">				    
					<dl>
						<dt><a rel="nofollow" href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($sid_code['q_uid']); ?>.html" target="_blank"><img width="80" height="80" alt="" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo get_user_key($sid_code['q_uid'],'img'); ?>"></a></dt>
						<dd class="gray02">
							<p>恭喜 <a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($sid_code['q_uid']); ?>.html" target="_blank" class="blue"><?php echo get_user_name($sid_code['q_uid']); ?></a>获得了本商品</p>
							<?php if($sid_go_record['ip']): ?>
							<?php echo get_ip($sid_go_record['id'],'ipcity'); ?>
							<?php endif; ?>
							<p>揭晓时间：<?php echo microt($sid_code['q_end_time']); ?></p>
							<p>1元淘时间：<?php echo microt($sid_go_record['time']); ?></p>
							<p>幸运1元淘码：<em class="orange Fb"><?php echo $sid_code['q_user_code']; ?></em></p>
						</dd>
					</dl>				
				</div>
			</div>
		...
		<div class="Pro_Detright">
			...
			<div class="Security">
				<ul>
					<li><a href="<?php echo WEB_PATH; ?>/help/4.html" target="_blank"><i></i>100%公平公正</a></li>
					<li><a href="<?php echo WEB_PATH; ?>/help/5.html" target="_blank"><s></s>100%正品保证</a></li>
					<li><a href="<?php echo WEB_PATH; ?>/help/7.html" target="_blank"><b></b>全国免费配送（支付宝特约商家）</a></li>
				</ul>
			</div>			
			<div class="Pro_Record">
				<ul id="ulRecordTab" class="Record_tit">
					<li class="NewestRec Record_titCur">最新1元淘记录</li>
					<li class="MytRec">我的1元淘记录</li>
					<li class="Explain orange">什么是一元淘吧？</li>
				</ul>
				<div class="Newest_Con hide">
					<ul>
						<?php $ln=1;if(is_array($us)) foreach($us AS $user): ?>
						<li>
						<a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($user['uid']); ?>.html" target="_blank">
						...
						<a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($user['uid']); ?>.html" target="_blank" class="blue"><?php echo $user['username']; ?></a>
						<?php if($user['ip']): ?>
						(<?php echo get_ip($user['id'],'ipcity'); ?>) 
						<?php endif; ?>				
						<?php echo _put_time($user['time']); ?> 1元淘了
				...
				<div class="My_Record hide" style="display:none;">
					...
					<ul>				
						...
						<li><?php echo _put_time($user['time']); ?>  1元淘了  <?php echo $user['gonumber']; ?>  个1元淘码</li>						
						<?php  endforeach; $ln++; unset($ln); ?> 
					</ul>
					<?php  else: ?>					
				...
				<div class="Newest_Con hide" style="display:none;">
					<p class="MsgIntro"><?php echo _cfg("web_name_two"); ?>是指只需1元就有机会买到想要的商品。即每件商品被平分成若干“等份”出售，每份1元，当一件商品所有“等份”售出后，根据1元淘规则产生一名幸运者，该幸运者即可获得此商品。</p>
					<p class="MsgIntro1"><?php echo _cfg("web_name_two"); ?>以“快乐1元淘，惊喜无限”为宗旨，力求打造一个100%公平公正、100%正品保障、寄娱乐与购物一体化的新型购物网站。<a href="<?php echo WEB_PATH; ?>/help/1" class="blue" target="_blank">查看详情&gt;&gt;</a></p>
				</div>
			</div>			
		</div>
	</div>
		    ...
		    $i=$i+1;
		     ?>
		            <li>
			            ...
			            <p class="name">
				            <a href="<?php echo WEB_PATH; ?>/goods/<?php echo $renqituijian['id']; ?>.html" target="_blank" title="一元淘吧<?php echo $renqituijian['title']; ?>">(第<?php echo $renqituijian['qishu']; ?>期)<?php echo $renqituijian['title']; ?></a>
			            </p>
