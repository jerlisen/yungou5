                ...
                <div class="yFootSupport">
                    <div class="yFootSupport_in">
                            ...
                            <dl>
                                ...
                                <dd><a href="<?php echo WEB_PATH; ?>/single/fund" target="_blank">会员公益</a></dd>
                            </dl>
                            <dl>
                                <dt>关于我们</dt>
                                <dd><a href="<?php echo WEB_PATH; ?>/help/1" target="_blank">了解魔窝</a></dd>
                                <dd><a href="<?php echo WEB_PATH; ?>/single/business" target="_blank">商务合作</a></dd>
                                <dd><a href="<?php echo WEB_PATH; ?>/help/13" target="_blank">联系我们</a></dd>
                            </dl>
                           <dl class="dl_Time">
                               <dd title="服务热线" style="background:url(<?php echo G_GLOBAL_STYLE; ?>/images/phone.png) no-repeat 0px 5px;">400-008-1387</dd>
                               ...
                               <dd title="魔窝云购公益基金"  id="nowTime" class="sysTime" style="background:url(<?php echo G_GLOBAL_STYLE; ?>/images/fund.png) no-repeat 0px 6px;background-size:21px;">
                        ...
                        <div class="footer-time-list">
                            <div class="yFootBottomRight">
                             &nbsp; Copyright (c) 2015 魔窝网 版权所有 &nbsp; 技术支持： &nbsp;<a href="http://www.1ytb.cc/" target="_blank" >深圳市魔电雷科技有限公司</a> <script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1256320941'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s11.cnzz.com/stat.php%3Fid%3D1256320941' type='text/javascript'%3E%3C/script%3E"));</script>
                            </div>
...
<img src="<?php echo G_GLOBAL_STYLE; ?>/images/ce.png" style="top:5%;position:relative;">
	<ul>
...
font-size: 16px;color: #FFF;" id="sl">
				购</br>物</br>车<em style="width: 18px;">0</em>
		...
		<li class="otherlifix otherlifixw">
			...
			<img src="statics/plugin/style/images/3.png" height="128" width="128">
			<s></s>
		</li>
		<li class="otherlifix otherlifixw">
			...
			<img width="188" height="188" src="/and.png" style="border:1px solid #adadad;"> 
