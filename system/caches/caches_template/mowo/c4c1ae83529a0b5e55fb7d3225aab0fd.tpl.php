...
<div class="g-wrap w1190">
       <!--最新揭晓-->
            ...
            <!--遥控模型整机-->
			<div class="g-title">
                <h3 class="fl"><i style="display: inline-block; width: 29px; height: 25px; font-style: normal; font-size: 14px; color: rgb(255, 255, 255); background: transparent url(&quot;http://www.ygqq.com/static/img/front/index/icon_index.png&quot;) no-repeat scroll -46px -22px; line-height: 30px; padding-left: 2px; margin-right: 18px; float: left; margin-top: 5px;">2F</i>遥控模型整机</h3>
			...
			<!--模型电子配件-->
			<div class="g-title">
                <h3 class="fl"><i style="display: inline-block; width: 29px; height: 25px; font-style: normal; font-size: 14px; color: rgb(255, 255, 255); background: transparent url(&quot;http://www.ygqq.com/static/img/front/index/icon_index.png&quot;) no-repeat scroll -46px -22px; line-height: 30px; padding-left: 2px; margin-right: 18px; float: left; margin-top: 5px;">3F</i>模型电子配件</h3>
			...
			<!--模型周边产品-->
			<div class="g-title">
                <h3 class="fl"><i style="display: inline-block; width: 29px; height: 25px; font-style: normal; font-size: 14px; color: rgb(255, 255, 255); background: transparent url(&quot;http://www.ygqq.com/static/img/front/index/icon_index.png&quot;) no-repeat scroll -46px -22px; line-height: 30px; padding-left: 2px; margin-right: 18px; float: left; margin-top: 5px;">4F</i>模型周边产品</h3>
                <div class="m-other fr"><a href="<?php echo WEB_PATH; ?>/goods_list/84_0_0" target="_blank" title="更多" class="u-more">更多</a></div>
            </div>

            <div class="announced-soon clrfix" id="divSoonGoodsList">
			<?php $data=$this->DB()->GetList("select * from `@#_shoplist` where `cateid`='84' and `q_uid` is null ORDER BY id DESC LIMIT 40",array("type"=>1,"key"=>'',"cache"=>0)); ?>
					 <?php $ln=1;if(is_array($data)) foreach($data AS $shop): ?>
			...
			<div class="g-title">
                ...
                <div class="m-other fr"><a href="<?php echo WEB_PATH; ?>/goods_list/85_0_0" target="_blank" title="更多" class="u-more">更多</a></div>
            </div>

            <div class="announced-soon clrfix" id="divSoonGoodsList">
			<?php $data=$this->DB()->GetList("select * from `@#_shoplist` where `cateid`='85' and `q_uid` is null ORDER BY id DESC LIMIT 40",array("type"=>1,"key"=>'',"cache"=>0)); ?>
					 <?php $ln=1;if(is_array($data)) foreach($data AS $shop): ?>
			...
			<!--虚拟充值类区-->
			<div class="g-title">
                <h3 class="fl"><i style="display: inline-block; width: 29px; height: 25px; font-style: normal; font-size: 14px; color: rgb(255, 255, 255); background: transparent url(&quot;http://www.ygqq.com/static/img/front/index/icon_index.png&quot;) no-repeat scroll -46px -22px; line-height: 30px; padding-left: 2px; margin-right: 18px; float: left; margin-top: 5px;">6F</i>虚拟充值类区</h3>
                <div class="m-other fr"><a href="<?php echo WEB_PATH; ?>/goods_list/87_0_0" target="_blank" title="更多" class="u-more">更多</a></div>
            </div>

            <div class="announced-soon clrfix" id="divSoonGoodsList">
			<?php $data=$this->DB()->GetList("select * from `@#_shoplist` where `cateid`='87' and `q_uid` is null ORDER BY id DESC LIMIT 40",array("type"=>1,"key"=>'',"cache"=>0)); ?>
					 <?php $ln=1;if(is_array($data)) foreach($data AS $shop): ?>
            ...
            <!--魔友晒单分享-->
			 <div class="g-title">
                <h3 class="fl"><i style="display: inline-block; width: 29px; height: 25px; font-style: normal; font-size: 14px; color: rgb(255, 255, 255); background: transparent url(&quot;http://www.ygqq.com/static/img/front/index/icon_index.png&quot;) no-repeat scroll -46px -22px; line-height: 30px; padding-left: 2px; margin-right: 18px; float: left; margin-top: 5px;">7F</i>魔友晒单分享</h3>
