...
<script src='<?php echo G_GLOBAL_STYLE; ?>/ichart.latest.min.js'></script>
				...
				listeners:{
					...
					parseText:function(tip,name,value,text,i){
						 return "<span style='color:#005268;font-size:12px;'>"+labels[i]+":00访问量约:<br/>"+
							"</span><span style='color:#005268;font-size:20px;'>"+value+"PV</span>";
					}
				}
			},
			crosshair:{
...
<div id='ichart-render' style="float:left;"></div>
 <div id='ichart-b' style="float:left; margin-left:20px;"></div>
 <div id='canvasDiv' style="float:left; margin-left:20px;margin-top:20px;"></div>
</div>
...
<!------------>
	...
	<div class="job">
        ...
        <div class="bk10"></div>
        <ul>
        	<li><i>程序版本:</i>锦尚中国第五版</li>
			<li><i>官方论坛:</i>bbs.52jscn.com</li>
            <li><i>专用主机:</i>host.52jscn.com</li>
	...
	<div class="job" style="padding-top:15px;">
		<p>上次登录时间: <?php echo date("Y-m-d H:i:s",$info['logintime']); ?></p><br>
            ...
            <p style="color:#666; padding:20px;font: 12px/1.5 tahoma,arial,宋体b8b\4f53,sans-serif;">
            	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;此系统为商业云购网站程序[功能加强版]，有多种实用插件，并可集成支付宝即时到帐接口
            </p> 
    </div>
<!------------>
</div>
