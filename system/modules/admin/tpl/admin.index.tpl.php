...
<div id="header">
    ...
    <div class="nav" id="nav">    
    	<ul>	
            ...
            <li class="normal"><a href="#" onClick="secBoard('nav',5,'yunapp','云应用');">淘吧助手</a></li>
...
<div id="left">
	...
	<li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/sign/sign_admin/lists/">签到设置</a></li>
	...
	<li class="head">直购商品</li>
	<li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/jf_goods_add">添加新商品</a></li>
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/jf_goods_list">商品列表</a></li>
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/category/lists/jf_goods">商品分类</a></li>
	<li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/jf_brand/lists">品牌管理</a></li>
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/jf_dingdan/lists">订单列表</a></li>
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/jf_dingdan/select">订单查询</a></li> 
	<li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/jf_dingdan/lists/notsend">等待发货</a></li>
	...
	<li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/cache/init">清空模板缓存</a></li>   
     ...
     <ul class="left_date" id="yunapp">     	
        ...
        <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/api/upfile">在线升级</a></li>
        <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/api/qqlogin/qq_set_config">QQ登陆</a></li> 
	    <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/api/qqlogin/wx_set_config">微信登陆</a></li>
		<li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/fund/fundset">公益基金</a></li>
        <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/auto/auto_p/show">自动购买</a></li>
	 ...
	 <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/admin/fund/specifylist">指定中奖人</a></li>
		<li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/api/plugin/admin/egglotter/listlotter">抽奖管理</a></li>
		<li class="head">充值卡管理</li>
		<li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/cardrecharge/cardrecharge">生成卡密</a></li>
        <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/cardrecharge/cardrecharge/lists">管理列表</a></li> 
	    <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/cardrecharge/cardrecharge/update_pwd">修改密码</a></li>
         ...
         <ul class="left_date" id="wechat">
            ...
            <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/setting/watermark">扫码引荐</a></li> -->
...
<div style="display: none"><a href="http://www.1ytb.cc/">源码分享</a></div>
</body>
</html>
