...
<li class="title">淘吧助手</li>
         <li><a href="<?php echo WEB_PATH; ?>/api/upfile">在线升级</a></li>
	 <li><a href="<?php echo WEB_PATH; ?>/api/plugin/get/bom">BOM检测</a></li> 
        <li><a href="<?php echo WEB_PATH; ?>/api/qqlogin/qq_set_config">QQ登陆</a></li> 
	    <li><a href="<?php echo WEB_PATH; ?>/api/qqlogin/wx_set_config">微信登陆</a></li>
		<li><a href="<?php echo G_MODULE_PATH; ?>/fund/fundset">公益基金</a></li>
        <li><a href="<?php echo WEB_PATH; ?>/auto/auto_p/show">自动购买</a></li>
	    <li><a href="<?php echo G_ADMIN_PATH; ?>/auto_register/show">批量注册</a></li>
		<?php if(file_exists(G_SYSTEM.'modules/goodspecify/lib/'.'itocode.class.php')){	?>
		<li><a href="<?php echo WEB_PATH; ?>/goodspecify/goodspecify/init">指定中奖人</a></li><?php } ?>
