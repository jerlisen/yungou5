...
<div style="margin-top:15px; margin-left:15px;">
	<form method="post" action="<?php echo G_ADMIN_PATH; ?>/auto_register/fileaction" enctype="multipart/form-data">
	         <h3>导入TXT文本：</h3><div class="box"><em>+</em><span>添加txt文本</span><input id="file" name="file" type="file"  class="filePrew" /></div>
	         <input type="submit"  value="导入并批量注册" class="btn_addPic" />
	</form>
</div>
	<br/>
	<hr/>
	<a class="btn" href="<?php echo G_PLUGIN_PATH ?>/PHPexcel/YS.TXT">点击浏览范例的TXT文本</a>
	<div style="padding:15px; width:90%; border-radius:5px; margin-top:30px; border:1px solid #3c8dbc; margin-left:10px;">
		...
		<p style="color:red">重点说明：用户名和邮箱是不能重复的，如果重复，重复项会被过滤。</p>
                 <p>  这四个值 都必须用  英文输入法下的   ，   逗号 分割</p>
                  <p> 一条记录完后必须换行 密码不写默认为  111111   六个1</p>
		  <p> 例子1</p>
                 <p>	我是用户名,111111,12345678@qq.com,13354545875</p>
                 <p> 例子2</p>
		 <p>	,,12345678@qq.com,13354545875</p>
                <p>  例子3</p>
                <p>	,,12345678@qq.com,</p>
                ...
                <p>	,,,13354545875</p>
                 ...
                 <p>	我是用户名,,12345678@qq.com,13354545875</p>
