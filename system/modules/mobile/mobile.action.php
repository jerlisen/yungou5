...
class mobile extends base {
	...
	public function init(){
		...
		//人气商品
		$shoplistrenqi=$this->db->GetList("select * from `@#_shoplist` where `renqi`='1' and `q_end_time` is null ORDER BY id DESC LIMIT 16");
		//获取广告
		$shop_ad=$this->db->GetList("select * from `@#_wap`  LIMIT 1");
		$max_renqi_qishu = 1;
