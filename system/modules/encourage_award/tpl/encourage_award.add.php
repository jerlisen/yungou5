...
<form name="myform" action=""  method="post">
	...
	<tr >
		...
		<td>
		<input type="radio" name="encourage_awardgz" id="encourage_award1" value="1" class="input-text">云购码与一等奖（幸运码）的距离由近到远依次设置鼓励奖
  	...
  	<tr>
		...
		<td>
			...
			<div><br> 
				2等奖奖励方式:
				<input type="radio" name="option1[]" value="淘豆:" class="input-text">淘豆&nbsp;&nbsp;
