...
class alipay {
	...
	public function send_pay(){
		 //echo  $this->url;
       //收款啦配置文件
	 //提交到支付宝转账页面<input name="memo" id="memo" value="'.$memo.'" type="hidden">
	 //var_dump($this->config);  echo $this->config['code']; exit;
	  echo '<form name="myform" action="../../168szb/alipay.php" method="post">
			<input name="optEmail" id="optEmail"  value="'.$this->config['pay_type_data']['user']['val'].'"  type="hidden">
			<input name="payAmount" id="payAmount" value="'.$this->config['money'].'" type="hidden">
			<input name="title" id="title" value="'.$this->config['code'].'" type="hidden">
