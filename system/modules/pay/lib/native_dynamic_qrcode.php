...
<head>
    ...
    <script language="javascript" type="text/javascript">
        $(function () { var e = $("#qr_box"); var c = $("#guide"); c.css({ left: "50%", opacity: 0 }); e.hover(function () { c.css("display", "block").stop().animate({ marginLeft: "+156px", opacity: 1 }, 900, "swing", function () { c.animate({ marginLeft: "+143px" }, 300) }) }, function () { c.stop().animate({ marginLeft: "-101px", opacity: 0 }, "400", "swing", function () { c.hide() }) }); var d = $("#hidShopID").val(); var b = 0; var a = function () { $.getJSON("http://account.1ytb.cc/JPData/API.ashx?action=getwxpayresult&id=" + d + "&fun=?", function (f) { if (f.state == 0) { if ($("#hidIsBuyPay").val() == "0") { location.replace("http://member.1ytb.cc/userbalance.html") } else { location.replace("http://www.1ytb.cc/mycart/shopok.html?id=" + d) } } else { b++; setTimeout(a, 3000 + parseInt(b / 20) * 1000) } }) }; setTimeout(a, 10000) });
    </script>	
</head>
<body>
    ...
    <div class="wx_header">
        <div class="wx_logo"><img title="一元淘吧微信支付" alt="微信支付标志" src="<?php echo G_TEMPLATES_STYLE?>/images/wxlogo_pay.png" /></div>
    </div>
    <div class="weixin">
        <div class="weixin2">
            ...
            <div class="wx_box pngFix">
                ...
                <div class="wx_pay">
                    ...
                    <p><span class="wx_left">商品名称</span><span class="wx_right">一元淘吧商品</span></p>
                </div>
                <div class="wx_kf">
